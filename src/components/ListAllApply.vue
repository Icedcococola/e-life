  ...
  <div id="l-ac">
    ...
    <el-table
      ...
      <el-table-column
        ...
        fixed="right">
        <template slot-scope="scope">
            <el-button type="primary" @click="agree(scope.row.goodsid)" round>同意</el-button>
            <el-button type="danger" @click="refuse(scope.row.goodsid)" round>拒绝</el-button>
        </template>
      </el-table-column>
    </el-table>
 ...
 export default {
      ...
      methods:
      {
          agree(goodsid){
             ...
             .then(()=>{
                 this.axios.get('/api/Goods/agree',
                 {
                     params:{
          ...
          refuse(goodsid){
              ...
              this.$confirm('确定拒绝该商品的上架申请？',
                           ...
                           {confirmButtonText:'确定',cancelButtonText:'取消'})
              .then(()=>{
                  this.axios.get('/api/Goods/refuse',
                  {
                      params:{
                          goodsid:this.goodsid
                      }
...
*/
        ...
        getTableData(){
          ...
          this.axios.get('/api/Goods/listallapply',{
          params:{
