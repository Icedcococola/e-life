    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
            <el-button type="primary" @click="modify(scope.row.pricelistid)" round>修改</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
 export default {
      ...
      methods:
      {
          modify(id){
              this.pricelistid = id
              this.$store.commit('SET_PRICELISTID',this.pricelistid)
              this.$router.push({
                 name:'ModifyPrice'
              });
          },
...
*/
        ...
        getTableData(){
          ...
          this.axios.get('/api/Servicea/findallprice',{
          params:{
            community:window.sessionStorage.getItem('community')
          }
          })
