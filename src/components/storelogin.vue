...
<el-row>
<el-button type="text" style="margin-bottom:4%" @click="toReg">还没有账号？马上注册</el-button>
</el-row>
    ...
    toHome(formName){
       this.$refs[formName].validate((valid)=>{
         if(valid){
           ...
           this.axios.get('/api/Store/Loginin',{
              params:{
            ...
            if(response.status === 200){
                ...
                if(a===0){
                  ...
                  this.$store.commit('SET_STORENAME',this.storenm)
                  this.$router.push({
                    name:'StoreHome',
                    params:{
                    data:response.data
