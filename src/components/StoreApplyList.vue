    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
            <el-button type="primary" @click="agree(scope.row.storename)" round>同意</el-button>
            <el-button type="danger" @click="refuse(scope.row.storename)" round>拒绝</el-button>
        </template>
      </el-table-column>
    </el-table>
 ...
 export default {
      ...
      methods:
      {
          agree(storename){
             ...
             this.$confirm('确定同意该商户的入驻申请？',
                           '提示',
                           {confirmButtonText:'确定',cancelButtonText:'取消'})
             .then(()=>{
                 this.axios.get('/api/Store/agree',
                 {
                     params:{
          ...
          refuse(storename){
              this.storename = storename;
              this.$confirm('确定拒绝该商户的入驻申请？',
                             '提示',
                           {confirmButtonText:'确定',cancelButtonText:'取消'})
              .then(()=>{
                  this.axios.get('/api/Store/refuse',
                  {
                      params:{
                          storename:this.storename,
                          community:window.sessionStorage.getItem('community')
...
*/
        ...
        getTableData(){
          ...
          this.axios.get('/api/Store/findallapply',{
          params:{
            community:window.sessionStorage.getItem('community')
          }
          })
